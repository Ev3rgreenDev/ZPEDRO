class ZCL_ZGW_SO_ORDER_MPC definition
  public
...
public section.
  ...
  types:
     TS_SALESORDER type ZST_SD_ORDER .
  types:
TT_SALESORDER type standard table of TS_SALESORDER .
  ...
  types:
     TS_SALESORDERHEADER type ZVND_H .
  types:
TT_SALESORDERHEADER type standard table of TS_SALESORDERHEADER .
  types:
     TS_SALESORDERITEMS type ZVND_I .
  types:
TT_SALESORDERITEMS type standard table of TS_SALESORDERITEMS .
  types:
     TS_SALESORDERCUSTOMER type ZCUST .
  types:
TT_SALESORDERCUSTOMER type standard table of TS_SALESORDERCUSTOMER .
  types:
     TS_SALESORDERMATERIAL type ZMAT .
  types:
TT_SALESORDERMATERIAL type standard table of TS_SALESORDERMATERIAL .
  types:
  ...
  constants GC_SALESORDERCUSTOMER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesOrderCustomer' ##NO_TEXT.
  constants GC_SALESORDERHEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesOrderHeader' ##NO_TEXT.
  constants GC_SALESORDERITEMS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesOrderItems' ##NO_TEXT.
  constants GC_SALESORDERMATERIAL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SalesOrderMaterial' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_SO_ORDER_MPC==========CP' ##NO_TEXT.
  ...
  methods DEFINE_SALESORDERHEADER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SALESORDERITEMS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SALESORDERCUSTOMER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SALESORDERMATERIAL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZGW_SO_ORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_SO_ORDER_SRV' ).

define_salesorder( ).
define_salesorderheader( ).
define_salesorderitems( ).
define_salesordercustomer( ).
define_salesordermaterial( ).
define_associations( ).
define_rds_4( ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'SHSI' "#EC NOTEXT
                            iv_left_type        = 'SalesOrderHeader' "#EC NOTEXT
                            iv_right_type       = 'SalesOrderItems' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SHSI
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Vbeln'   iv_dependent_property = 'Vbeln' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SHSISet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SalesOrderHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesOrderItemsSet'             "#EC NOTEXT
                                              iv_association_name      = 'SHSI' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'SHSC' "#EC NOTEXT
                            iv_left_type        = 'SalesOrderCustomer' "#EC NOTEXT
                            iv_right_type       = 'SalesOrderHeader' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '0'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SHSC
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Custid'   iv_dependent_property = 'Custid' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SHSCSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SalesOrderCustomerSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesOrderHeaderSet'             "#EC NOTEXT
                                              iv_association_name      = 'SHSC' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'SISM' "#EC NOTEXT
                            iv_left_type        = 'SalesOrderMaterial' "#EC NOTEXT
                            iv_right_type       = 'SalesOrderItems' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = '0'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - SISM
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Matnr'   iv_dependent_property = 'Matnr' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'SISMSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'SalesOrderMaterialSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesOrderItemsSet'             "#EC NOTEXT
                                              iv_association_name      = 'SISM' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_items' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'SHSI' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_cust' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TO_CUST' "#EC NOTEXT
                                                              iv_association_name = 'SHSC' ). "#EC NOTEXT
* Navigation Properties for entity - SalesOrderItems
lo_entity_type = model->get_entity_type( iv_entity_name = 'SalesOrderItems' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_header' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'SHSI' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_material' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TO_MATERIAL' "#EC NOTEXT
                                                              iv_association_name = 'SISM' ). "#EC NOTEXT
* Navigation Properties for entity - SalesOrderCustomer
lo_entity_type = model->get_entity_type( iv_entity_name = 'SalesOrderCustomer' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_header' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TO_HEADER' "#EC NOTEXT
                                                              iv_association_name = 'SHSC' ). "#EC NOTEXT
* Navigation Properties for entity - SalesOrderMaterial
lo_entity_type = model->get_entity_type( iv_entity_name = 'SalesOrderMaterial' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'to_items' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TO_ITEMS' "#EC NOTEXT
                                                              iv_association_name = 'SISM' ). "#EC NOTEXT
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DataDoc' iv_abap_fieldname = 'DATA_DOC' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Moeda' iv_abap_fieldname = 'MOEDA' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValBruto' iv_abap_fieldname = 'VAL_BRUTO' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValDesc' iv_abap_fieldname = 'VAL_DESC' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValLiq' iv_abap_fieldname = 'VAL_LIQ' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Locid' iv_abap_fieldname = 'LOCID' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValItem' iv_abap_fieldname = 'VAL_ITEM' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DescIt' iv_abap_fieldname = 'DESC_IT' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ValLiqItem' iv_abap_fieldname = 'VAL_LIQ_ITEM' ). "#EC NOTEXT
lo_property->set_type_edm_decimal( ).
lo_property->set_precison( iv_precision = 3 ). "#EC NOTEXT
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZST_SD_ORDER'
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_SALESORDERCUSTOMER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - SalesOrderCustomer
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesOrderCustomer' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Cpf' iv_abap_fieldname = 'CPF' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 11 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ativo' iv_abap_fieldname = 'ATIVO' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZCUST'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesOrderCustomerSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'HoraDoc' iv_abap_fieldname = 'HORA_DOC' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Obs' iv_abap_fieldname = 'OBS' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 60 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVND_H'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesOrderItems' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVND_I'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesOrderItemsSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_SALESORDERMATERIAL.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - SalesOrderMaterial
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SalesOrderMaterial' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Unid' iv_abap_fieldname = 'UNID' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZMAT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SalesOrderMaterialSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20251001162421'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20251001162422'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20251001162422'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZGW_SO_ORDER' )
...
ls_text_element-artifact_name          = 'HoraDoc'.                 "#EC NOTEXT
